...
public class FixedOnTouchListener implements View.OnTouchListener {
  ...
  public FixedOnTouchListener(View.OnTouchListener wrappedWrapped) {
  ...
  public static class BareFixedOnTouchListener implements View.OnTouchListener {

    // If caller sets these, tracing info will be appended to them
    public ArrayList<String> mAnnotationsOrNull = null;
    public ArrayList<BareFixedOnTouchListener.ForbidRecord> mForbidRecordsOrNull = null;

    public View.OnTouchListener wrapped = null;
    public BareFixedOnTouchListener(View.OnTouchListener wrapped) {
    ...
    public boolean onTouch(View view, MotionEvent unfixedEvent) {
      ...
      if (verboseLevel >= 1) Log.i(TAG, "    in BareFixedOnTouchListener onTouch");
      ...
      if (verboseLevel >= 1) Log.i(TAG, "    out BareFixedOnTouchListener onTouch, returning "+answer);
      return answer;
    }  // onTouch
  }  // class BareFixedOnTouchListener
